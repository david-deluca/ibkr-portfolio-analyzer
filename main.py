...
if __name__ == "__main__":
    ...
    parser.add_argument("--dashboard", action="store_true", help="Generate full portfolio dashboard")
    ...
    if args.summary:
        ...
        print("Use --summary, --performance, --projection, --distribution, or --dashboard to run the respective analysis.")